...
REPO_URL="${REPO_URL:-https://github.com/bacproxmox/homelabv2.3.10.git}"
INSTALL_DIR="${INSTALL_DIR:-/root/homelabv2.3.10}"
BRANCH="${BRANCH:-main}"
BOOTSTRAP_MARKER="/root/.homelabv2.3.10-bootstrap-reboot-done"
export HOMELAB_VERSION="2.3.10"
...
safe_reboot_gate() {
  if need_safe_reboot; then
    if [[ ! -f "$BOOTSTRAP_MARKER" ]]; then
      ...
      echo "bash <(curl -fsSL https://raw.githubusercontent.com/bacproxmox/homelabv2.3.10/main/bootstrap.sh)"
      echo
      sleep 8
      reboot
    else
...
echo "========================================="
echo " Homelab v2.3.10 - Bootstrap"
...
echo
echo "Starting Homelab v2.3.10 menu..."
