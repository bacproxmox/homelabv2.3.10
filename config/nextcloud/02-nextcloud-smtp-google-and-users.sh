...
rscp "$TMP/nextcloud-post-config.sh" 104 /tmp/hv2310-nextcloud-post-config.sh
rscp "$TMP/nextcloud-post.env" 104 /tmp/hv2310-nextcloud-post.env
rssh 104 "sudo bash -c 'set -a; source /tmp/hv2310-nextcloud-post.env; set +a; bash /tmp/hv2310-nextcloud-post-config.sh; rm -f /tmp/hv2310-nextcloud-post.env'"
